    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnTransfer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        if (matchFound) {
                            ...
                            if (userSendingKey != null && receivingUser[0].getDataBaseId() != null) {
                                ...
                                Log.v("Transfer:", "Testing the boolean BEFORE");
                                boolean ableToTransfer = userSendingBalance[0] > 0 && userSendingBalance[0] >= amount;
                                Log.v("Transfer:", "Testing the boolean BEFORE" + ableToTransfer);
                                if (ableToTransfer) {
                                    Log.v("Transfer:", "Testing the boolean INSIDE");
                                    ...
                                    firebase.child(receivingUser[0].getDataBaseId()).child("balance")
                ...
                // set a time and return to main activity
